...
class LINE extends Command {
    ...
    get myBot() {
        const bot = ['ufe4357997ea42b09a8001145fb359ba6'];
        return bot; 
    }
    ...
    async textMessage(messages) {
        ...
        this.command(`แทค ${payload}`,this.kickAll.bind(this));
        ...
        this.command(`Run ${payload}`,this.SpamGroup.bind(this));
        ...
        if(txt === '!มาละลืม' && this.stateStatus.kick == 1 && seq.toType == 2) {
        ...
        }else if(txt === '!มาละลืม' && seq.toType == 2){this._sendMessage(seq,"Not permitted !");}
